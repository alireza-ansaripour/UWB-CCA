...
void mac_frame_init_mac_frame_ctrl(mac_frame_802_15_4_format_t *mac_frame_ptr)
{
     ...
     */
    mac_frame_ptr->mhr_802_15_4.frame_ctrl[0] = 0x61;
    mac_frame_ptr->mhr_802_15_4.frame_ctrl[1] = 0x88;
    //MAC_FRAME_FRAME_CTRL_802_15_4(mac_frame_ptr, 0)
    //    = (MAC_FRAME_TYPE_802_15_4_DATA << MAC_FRAME_TYPE_SHIFT_VALUE) | (MAC_SEC_EN_UN_PROTECTED << MAC_FRAME_SECURITY_ENABLED_SHIFT_VALUE)
